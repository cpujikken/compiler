...
loop3.140:
	...
	jl	jge_else.382
	movl	%esi, 0(%ebp)	#test/matmul-flat.ml:3:17->3:22
	movl	(%edi,%eax,4), %esi	#test/matmul-flat.ml:3:17->3:22
	movl	%edi, 4(%ebp)	#test/matmul-flat.ml:3:17->3:22
	movl	(%edi,%eax,4), %edi	#test/matmul-flat.ml:3:17->3:22
	movsd	(%edi,%ecx,8), %xmm0	#test/matmul-flat.ml:3:17->3:26
	movl	(%edx,%eax,4), %edi	#test/matmul-flat.ml:3:30->3:35
	movsd	(%edi,%ebx,8), %xmm1	#test/matmul-flat.ml:3:30->3:39
	movl	0(%ebp), %edi	#test/matmul-flat.ml:3:43->3:48
	movl	(%edi,%ebx,4), %edi	#test/matmul-flat.ml:3:43->3:48
	movsd	(%edi,%ecx,8), %xmm2	#test/matmul-flat.ml:3:43->3:52
	mulsd	%xmm2, %xmm1	#test/matmul-flat.ml:3:30->3:52
	addsd	%xmm1, %xmm0	#test/matmul-flat.ml:3:17->3:52
	movsd	%xmm0, (%esi,%ecx,8)	#test/matmul-flat.ml:3:4->3:52
	subl	$1, %ebx	#test/matmul-flat.ml:4:13->4:18
	movl	0(%ebp), %esi	#test/matmul-flat.ml:4:4->4:27
	movl	4(%ebp), %edi	#test/matmul-flat.ml:4:4->4:27
